...
class Triangle extends Shape{
    ...
    render(){
        return `<svg width="300px" height="200px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill=${this.color} stroke="#000000" stroke-width="1" stroke-linecap="round" stroke-linejoin="miter"><polygon points="12 3 2.5 21 21.5 21 12 3"></polygon></svg>`
    };
};
...
class Circle extends Shape{
    ...
    render(){
        return `<svg fill=${this.color} width="300px" height="200px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
class Square extends Shape{
    ...
    render(){
        return `<svg width="300px" height="200px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill=${this.color} stroke="#000000" stroke-width="1" stroke-linecap="round" stroke-linejoin="miter"><rect x="2" y="2" width="20" height="20" rx="0"></rect></svg>`
    };
};
