...
class Triangle extends Shape{
    ...
    render(){
        return `<polygon fill="${this.color}" points="150, 18 244, 182 56, 182"></polygon>`
    };
};
...
class Circle extends Shape{
    ...
    render(){
        return `<circle fill="${this.color}" cx="150" cy="100" r="75"></circle>`
    };
};
...
class Square extends Shape{
    ...
    render(){
        return `<rect fill="${this.color}" x="50" width="200" height="200"></rect>`
    };
};
